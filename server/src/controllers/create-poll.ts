...
export default (dbStore: SnapshotPollingServices['dbStore']) => ({ orgName, title, description, voteTokenResource, closes }: { orgName: string, title: string, description: string, voteTokenResource: string, closes: number }) => {
